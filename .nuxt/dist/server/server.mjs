...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_ZoEERe91zG = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const __vite_ssr_import_0__ = await __vite_ssr_import__("/composables/useDarkMode.ts");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<!--[--><!-- {{beerName}} --><div class="header" style="${__vite_ssr_import_5__.ssrRenderStyle($setup.isDarkMode ? { backgroundColor: "rgb(22, 22, 30)", color: "white" } : null)}"><div class="header__text"><h1 class="header__main">Beer API</h1><h3 class="header__submain">Search for your favourite beer</h3></div><!-- <div class="icons">
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_fymXuTzPYQ = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const __vite_ssr_import_0__ = await __vite_ssr_import__("/node_modules/nuxt/dist/app/index.mjs");
...
const _sfc_main = {
  ...
  expose();
    ...
    const { data: fav, refresh } = __vite_ssr_import_0__.useAsyncData("fav", () => {
...
const __returned__ = { fav, refresh, isDarkMode, toggleDarkMode, deleteItem }
Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true })
return __returned__
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  __vite_ssr_import_4__.ssrRenderList($setup.fav, (favItem, index) => {
    _push(`<div class="item"><div class="buttons"><span class="delete-btn"></span><span class="like-btn"></span></div><div class="image"><img${
      __vite_ssr_import_4__.ssrRenderAttr("src", favItem.item.image_url)
    } alt="" style="${
      __vite_ssr_import_4__.ssrRenderStyle({"width":"25px","padding-top":"1em","cursor":"pointer"})
    }"></div><div class="description"><span>${
      __vite_ssr_import_4__.ssrInterpolate(favItem.item.name)
    }</span><span>${
      __vite_ssr_import_4__.ssrInterpolate(favItem.item.first_brewed)
    }</span><span>${
      __vite_ssr_import_4__.ssrInterpolate(favItem.item.tagline)
    }</span></div><div class="total-price">\$${
      __vite_ssr_import_4__.ssrInterpolate(favItem.item.ebc)
    }</div><button type="button" class="remove">x</button></div>`)
  })
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_jj6Tq10p1C = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const __vite_ssr_import_0__ = await __vite_ssr_import__("/composables/useDarkMode.ts");
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_aLkLvrkqZh = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const __vite_ssr_import_0__ = await __vite_ssr_import__("/node_modules/nuxt/dist/app/index.mjs");
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_nn7V38lY2W = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const __vite_ssr_import_0__ = await __vite_ssr_import__("/composables/useDarkMode.ts");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<header${__vite_ssr_import_3__.ssrRenderAttrs(__vite_ssr_import_2__.mergeProps({
    class: "site-header",
    style: $setup.isDarkMode ? { backgroundColor: "rgb(22,22,30)" } : null
  }, _attrs))}><div class="site-identity" style="${__vite_ssr_import_3__.ssrRenderStyle($setup.isDarkMode ? { color: "white" } : null)}"><h1><a href="/beer" style="${__vite_ssr_import_3__.ssrRenderStyle($setup.isDarkMode ? { color: "white" } : null)}">Punk Beer Api</a></h1></div><nav class="site-navigation"><ul class="nav"><li><a href="/cart" style="${__vite_ssr_import_3__.ssrRenderStyle($setup.isDarkMode ? { color: "white" } : null)}"> Cart </a></li><li><a href="/fav" style="${__vite_ssr_import_3__.ssrRenderStyle($setup.isDarkMode ? { color: "white" } : null)}"> WishList </a></li><!-- <li>
          <p>
        ...
        </li> --><li><label class="switch"><input type="checkbox"${__vite_ssr_import_3__.ssrIncludeBooleanAttr(Array.isArray($setup.isDarkMode) ? __vite_ssr_import_3__.ssrLooseContain($setup.isDarkMode, null) : $setup.isDarkMode) ? " checked" : ""}><span class="slider round"></span></label></li></ul></nav></header>`);
}
...
const __modules__ = {
  ...
  "/components/V-header.vue": $id_nn7V38lY2W,
